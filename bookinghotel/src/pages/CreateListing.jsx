      ...
      <form action="">
        ...
        <div className="flex items-center mb-6">
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input type="number" name="regularPrice" id={regularPrice} onchange={onChange} min="50" max="500000000" required
        ...
        {offer && (
          ...
          <div className="">
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              <input type="number" name="discountedPrice" id={discountedPrice} onchange={onChange} min="50" max="500000000" required={offer}
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-while focus:border-slate-600 text-center"
              />
            </div>
          </div>
