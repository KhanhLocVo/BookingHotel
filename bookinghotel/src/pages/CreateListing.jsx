...
export default function CreateListing() {
  ...
  async function onSubmit(e){
    ...
    //   const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key=${process.env.REACT_APP_GEODODE_API_KEY}`);
  ...
  return (
    <main className="bg">
      ...
      <div className="max-w-md px-2 mx-auto">
        <h1 className="text-3xl text-center pt-2 font-bold">Create a Listing</h1>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="flex items-center mb-6">
            <div className="">
              ...
              <div className="flex w-full justify-center items-center space-x-6">
                <input type="number" id="regularPrice" value={regularPrice} onChange={onChange} min="50" max="500000000" required
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-while focus:border-slate-600 text-center"
                />
          ...
          {offer && (
            ...
            <div className="">
              ...
              <div className="flex w-full justify-center items-center space-x-6">
                <input type="number" id="discountedPrice" value={discountedPrice} onChange={onChange} min="50" max="500000000" required={offer}
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-while focus:border-slate-600 text-center"
                />
              </div>
            </div>
          ...
          <button 
            type="submit" 
            className="mb-6 w-full px- py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
          >Create Listing
          </button>
